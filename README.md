...
| update one user's comments | PUT           | support/:id       | `{username: 'Dino88', comment: '...'}` | updates comment for specified album, username, and comment with new comment | `{username: 'Dino88', comment: 'new...comment'}` |
